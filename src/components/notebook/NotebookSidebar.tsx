...
export const NotebookSidebar: React.FC<NotebookSidebarProps> = ({
  ...
  return (
    <aside className="w-64 sm:w-72 h-full border-r border-slate-200 dark:border-slate-800 bg-slate-50/90 dark:bg-slate-900/80 flex flex-col select-none shrink-0 overflow-hidden">
                                  ...
                                  .map((page) => {
                                    ...
                                    return (
                                      ...
                                      >
                                        ...
                                        <div className="flex items-center gap-1">
                                          {page.favorite && (
                                            <Star className={`w-3 h-3 ${isPageActive ? 'text-amber-300 fill-amber-300' : 'text-amber-400 fill-amber-400'}`} />
                                          )}
                                          <button
                                            onClick={(e) => {
                                              e.stopPropagation();
